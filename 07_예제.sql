...
SELECT EMP_ID, EMP_NAME, JOB_NAME,
	TO_CHAR( EXTRACT(YEAR FROM SYSDATE))-TO_CHAR(DECODE(SUBSTR(EMP_NO, 8, 1), '1', '19', '2', '19', '20') || SUBSTR(EMP_NO, 1, 2)) 나이,
	TO_CHAR(SALARY * (1 + NVL(BONUS, '0') * 12), 'L999,999,999') 연봉
FROM EMPLOYEE E1
JOIN JOB J ON (J.JOB_CODE = E1.JOB_CODE)
WHERE 
	TO_CHAR( EXTRACT(YEAR FROM SYSDATE))-TO_CHAR(DECODE(SUBSTR(EMP_NO, 8, 1), '1', '19', '2', '19', '20') || SUBSTR(EMP_NO, 1, 2))
	= (SELECT MIN(TO_CHAR( EXTRACT(YEAR FROM SYSDATE))-TO_CHAR(DECODE(SUBSTR(EMP_NO, 8, 1), '1', '19', '2', '19', '20') || SUBSTR(EMP_NO, 1, 2)))
				FROM EMPLOYEE E2
